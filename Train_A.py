...
from model.Extralonger import Extralonger,Extralonger_A
@torch.no_grad()
...
if __name__ == "__main__":
    ...
    assert dataset in ["PEMS04", "PEMS08", "SEATTLE","PEMS03","PEMS07"]
    ...
    model = Extralonger_A(**cfg["model_args"], adj_mask=adj_mask)
